...
ALTER TABLE "studio_number_sequences" ADD CONSTRAINT "studio_number_sequences_studio_id_studios_studio_id_fk" FOREIGN KEY ("studio_id") REFERENCES "public"."studios"("studio_id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
